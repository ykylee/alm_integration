...
const pageContent = {
  ...
  organization: {
    ...
    "sys-admin": {
      ...
      summary: "조직 변경이 내부 마스터와 승인 경로에 주는 영향을 본다.",
      points: [
        ["영향 과제", "활성 과제 12건"],
        ["승인 루트", "4건 재계산 필요"],
  ...
  admin: {
    ...
    "org-head": {
      ...
      summary: "조직장 승인 정책과 변경 반영 이력이 어떻게 적용되는지 확인한다.",
      points: [
        ["승인 정책", "프로젝트리더/조직장 분리 적용"],
        ["변경 반영", "조직명 변경과 루트 재배치 확인"],
        ["감사", "주요 상태 변경 이력 조회"],
      ],
    },
    "sys-admin": {
      ...
      summary: "연계 상태, 조직 변경 반영, 권한 예외와 감사 로그를 함께 본다.",
      points: [
        ["연계 경고", "Jira/Bamboo/HR Sync 상태 확인"],
        ["변경 큐", "조직 변경 영향 6건 처리"],
        ["감사", "주요 상태 변경 37건 보관"],
      ],
    },
